...
public final class GroupViewHolder
    ...
    private GroupViewHolder(@NonNull final PrefsLibHeaderBinding vb,
    ...
    @NonNull
    static GroupViewHolder create(@NonNull final LayoutInflater inflater,
                                  @NonNull final ViewGroup parent,
                                  @NonNull final Function<Integer, Setting> itemProvider,
                                  @NonNull final UICallback listener) {
        final PrefsLibHeaderBinding vb = PrefsLibHeaderBinding
                .inflate(inflater, parent, false);
        return new GroupViewHolder(vb, itemProvider, listener);
    }
}
