...
public final class ActionViewHolder
    ...
    private ActionViewHolder(@NonNull final PrefsLibTextViewBinding vb,
    ...
    @NonNull
    static ActionViewHolder create(@NonNull final LayoutInflater inflater,
                                   @NonNull final ViewGroup parent,
                                   @NonNull final Function<Integer, Setting> itemProvider,
                                   @NonNull final UICallback listener) {
        final PrefsLibTextViewBinding vb = PrefsLibTextViewBinding
                .inflate(inflater, parent, false);
        return new ActionViewHolder(vb, itemProvider, listener);
    }
}
