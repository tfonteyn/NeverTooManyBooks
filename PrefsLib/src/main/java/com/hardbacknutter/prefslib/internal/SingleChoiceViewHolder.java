...
public final class SingleChoiceViewHolder
        extends SettingViewHolder {

    private SingleChoiceViewHolder(@NonNull final PrefsLibTextViewBinding vb,
        ...
        itemView.setOnClickListener(v -> {
            ...
            final SingleChoiceSetting setting = (SingleChoiceSetting) itemProvider.apply(position);
            listener.showDialog(setting);
        });
    }

    @NonNull
    static SingleChoiceViewHolder create(@NonNull final LayoutInflater inflater,
                                         @NonNull final ViewGroup parent,
                                         @NonNull final Function<Integer, Setting> itemProvider,
                                         @NonNull final UICallback listener) {
        final PrefsLibTextViewBinding vb = PrefsLibTextViewBinding
                .inflate(inflater, parent, false);
        return new SingleChoiceViewHolder(vb, itemProvider, listener);
    }
}
