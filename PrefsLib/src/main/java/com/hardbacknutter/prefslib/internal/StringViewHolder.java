...
public final class StringViewHolder
    ...
    private StringViewHolder(@NonNull final PrefsLibTextViewBinding vb,
        ...
        itemView.setOnClickListener(v -> {
            ...
            final StringSetting setting = (StringSetting) itemProvider.apply(position);
            listener.showDialog(setting);
        });
    }

    @NonNull
    static StringViewHolder create(@NonNull final LayoutInflater inflater,
                                   @NonNull final ViewGroup parent,
                                   @NonNull final Function<Integer, Setting> itemProvider,
                                   @NonNull final UICallback listener) {
        final PrefsLibTextViewBinding vb = PrefsLibTextViewBinding
                .inflate(inflater, parent, false);
        return new StringViewHolder(vb, itemProvider, listener);
    }
}
