...
/**
 * Copied 2024-12-21 from android-35  java.net.InMemoryCookieStore
 * <p>
...
public class BiscuitStore
    ...
    */
     ...
     */
    private boolean netscapeDomainMatches(String domain,
                                          String host) {
    ...
    private void getInternal1(List<HttpCookie> cookies,
                              Map<URI, List<HttpCookie>> cookieIndex,
                              String host) {
        // BEGIN Android-changed: InMemoryCookieStore ignores scheme (http/https). b/25897688
    ...
    void getInternal2(List<HttpCookie> cookies,
