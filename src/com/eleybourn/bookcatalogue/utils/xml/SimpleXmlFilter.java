...
public class SimpleXmlFilter {
    ...
    public SimpleXmlFilter(final @NonNull XmlFilter root) {
        mRootFilter = root;
    }
    ...
    @NonNull
    public SimpleXmlFilter isArray(final @NonNull String arrayName) {
    ...
    @NonNull
    public SimpleXmlFilter popTo(@SuppressWarnings("SameParameterValue") final @NonNull String tag) {
    ...
    @NonNull
    public SimpleXmlFilter longAttr(final @NonNull String attrName, final @NonNull String key) {
        List<AttrFilter> attrs = getAttrFilters();
    ...
    @NonNull
    public SimpleXmlFilter stringAttr(final @NonNull String attrName, final @NonNull String key) {
        List<AttrFilter> attrs = getAttrFilters();
    ...
    @SuppressWarnings("SameParameterValue")
    @NonNull
    public SimpleXmlFilter booleanBody(final @NonNull String tag, final @NonNull String fieldName) {
    ...
    @SuppressWarnings("SameParameterValue")
    @NonNull
    public SimpleXmlFilter doubleBody(final @NonNull String tag, final @NonNull String fieldName) {
    ...
    @NonNull
    public SimpleXmlFilter longBody(final @NonNull String tag, final @NonNull String fieldName) {
        setCollector(tag, mLongHandler, fieldName);
        return this;
    }

    @NonNull
    public SimpleXmlFilter stringBody(final @NonNull String fieldName) {
        setCollector(mTextHandler, fieldName);
        return this;
    }

    @NonNull
    public SimpleXmlFilter stringBody(final @NonNull String tag, final @NonNull String fieldName) {
