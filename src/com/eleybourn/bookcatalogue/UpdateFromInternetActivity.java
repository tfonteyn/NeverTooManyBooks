 ...
 */
public class UpdateFromInternetActivity extends ActivityWithTasks {
    ...
    private void setupFields(final long bookId) {
        ...
        for (FieldUsages.FieldUsage usage : mFieldUsages.values()) {
            ...
            cb.setOnClickListener(new OnClickListener() {
                ...
                private void setCheckBoxText(@NonNull final TextView v, final int textId, final int extraId) {
                    v.setText(getString(R.string.a_bracket_b_bracket,
                            getString(textId),
                            getString(extraId)));
                }
            });
        ...
        findViewById(R.id.confirm).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (readUserSelections() == 0) {
                    StandardDialogs.showQuickNotice(UpdateFromInternetActivity.this, R.string.select_min_1_field);
                    return;
                }
