...
public class FastScrollListView
    ...
    public static class FastScroller {
        ...
        private final ScrollFade mDeferHide;
        private int mThumbH;
        private int mThumbW;
        private int mThumbY;
        ...
        private void drawOverlay(@NonNull final Canvas canvas) {
            ...
            if (line2 != null) {
                ...
                canvas.drawText(line2, tx, ty + s, paint);
                // reset for next time
                paint.setTextSize(s);
            }
        }
        ...
        private void scrollTo(final float position) {
            ...
            if (mList instanceof ExpandableListView) {
                ...
                mList.setSelectionFromTop(index + mHeaderCount, 0);
            } else {
            ...
            if (mSectionIndexerV2 != null) {
                ...
                if ((sections != null && sections.length > 1) && (mSectionIndexer != null)) {
