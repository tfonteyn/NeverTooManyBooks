...
public class CursorAdapterWrapper
    ...
    @NonNull
    @Override
    public MultiTypeListCursorAdapter.Holder onCreateViewHolder(@NonNull final ViewGroup parent,
                                                                final int viewType) {
        View itemView = mCursorAdapter.newView(mContext, mCursorAdapter.getCursor(), parent);
        return new MultiTypeListCursorAdapter.Holder(itemView);
    }

    @Override
    @CallSuper
    public void onBindViewHolder(@NonNull final MultiTypeListCursorAdapter.Holder holder,
                                 final int position) {
