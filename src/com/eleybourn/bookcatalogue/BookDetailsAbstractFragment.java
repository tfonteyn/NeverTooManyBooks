...
public abstract class BookDetailsAbstractFragment extends EditBookAbstractFragment {
    ...
    private final OnCreateContextMenuListener mCreateBookThumbContextMenuListener = new OnCreateContextMenuListener() {
        ...
        public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
            ...
            add_photo.setIcon(BookCatalogueApp.getAttr(R.attr.ic_add_a_photo));
            ...
            alt_covers.setIcon(BookCatalogueApp.getAttr(R.attr.ic_zoom_in));
            ...
            rotate_photo_cw.setIcon(BookCatalogueApp.getAttr(R.attr.ic_rotate_right));
            MenuItem rotate_photo_ccw = submenu.add(0, CONTEXT_ID_ROTATE_THUMB_CCW, 2, R.string.menu_rotate_thumb_ccw);
            rotate_photo_ccw.setIcon(BookCatalogueApp.getAttr(R.attr.ic_rotate_left));
            ...
            crop_thumb.setIcon(BookCatalogueApp.getAttr(R.attr.ic_crop));
        }
    };
