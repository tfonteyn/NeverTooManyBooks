...
import static com.eleybourn.bookcatalogue.tasks.taskqueue.TaskQueueDBHelper.DOM_NAME;
import static com.eleybourn.bookcatalogue.tasks.taskqueue.TaskQueueDBHelper.DOM_PRIORITY;
import static com.eleybourn.bookcatalogue.tasks.taskqueue.TaskQueueDBHelper.DOM_QUEUE_ID;
import static com.eleybourn.bookcatalogue.tasks.taskqueue.TaskQueueDBHelper.DOM_RETRY_COUNT;
...
import static com.eleybourn.bookcatalogue.tasks.taskqueue.TaskQueueDBHelper.TBL_QUEUE;
...
class TaskQueueDBAdapter {
    ...
    TasksCursor getTasks() {
        return TasksCursor.fetchTasks(getDb(), TaskCursorSubtype.all);
    }
    ...
    TasksCursor getTasks(final long category) {
        return TasksCursor.fetchTasks(getDb(), category, TaskCursorSubtype.active);
    }
