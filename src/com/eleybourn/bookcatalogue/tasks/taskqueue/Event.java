 ...
 * do not prevent the task from completing. Examples might include a long running exportBooks job
 * in which 3 items fail, but 1000 succeed -- in this case it is useful to exportBooks the successful
