...
/**
 * DB Helper for Covers DB on external storage. It uses the Application Context.
 *
...
public class CoversDbAdapter implements AutoCloseable {
     ...
     *
     * Reminder: we use the application context solely for the datbase connection.
     */
    ...
    private void open(final @NonNull Context context) {
        final SQLiteOpenHelper coversHelper = new CoversDbHelper(context,
    ...
    private static class CoversDbHelper extends SQLiteOpenHelper {
