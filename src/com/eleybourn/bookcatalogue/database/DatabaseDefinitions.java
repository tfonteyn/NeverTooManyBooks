...
public class DatabaseDefinitions {
    ...
    public static final DomainDefinition DOM_RATING = new DomainDefinition("rating", TableInfo.TYPE_FLOAT, "default 0", NOT_NULL);
    public static final DomainDefinition DOM_READ = new DomainDefinition("read", TableInfo.TYPE_INTEGER);
