...
public class DatabaseDefinitions {
    ...
    public static final DomainDefinition DOM_DATE_ADDED = new DomainDefinition("date_added", TableInfo.TYPE_DATETIME,"", "default current_timestamp" );
    ...
    public static final DomainDefinition DOM_UPDATE_DAY = new DomainDefinition("read_day", TableInfo.TYPE_INT);
    public static final DomainDefinition DOM_UPDATE_MONTH = new DomainDefinition("read_month", TableInfo.TYPE_INT);
    public static final DomainDefinition DOM_UPDATE_YEAR = new DomainDefinition("read_year", TableInfo.TYPE_INT);
    ...
    public static final DomainDefinition DOM_LOCATION = new DomainDefinition("location", TableInfo.TYPE_TEXT, "default ''");
    ...
    public static final DomainDefinition DOM_PAGES = new DomainDefinition("pages", TableInfo.TYPE_INTEGER);
    public static final DomainDefinition DOM_POSITION = new DomainDefinition("position", TableInfo.TYPE_INTEGER, NOT_NULL, "");
    ...
    public static final DomainDefinition DOM_RATING = new DomainDefinition("rating", TableInfo.TYPE_FLOAT, NOT_NULL, "default 0");
    public static final DomainDefinition DOM_READ = new DomainDefinition("read", TableInfo.TYPE_INTEGER, NOT_NULL, "default 0");
    public static final DomainDefinition DOM_SIGNED = new DomainDefinition("signed", TableInfo.TYPE_BOOLEAN, NOT_NULL, "default 0");
    ...
    public static final DomainDefinition DOM_READ_END = new DomainDefinition("read_end", TableInfo.TYPE_DATE);
    ...
    public static final DomainDefinition DOM_READ_START = new DomainDefinition("read_start", TableInfo.TYPE_DATE);
    ...
    public static final TableDefinition TBL_BOOK_LIST_DEFN = new TableDefinition(TBL_BOOK_LIST_NAME)
            .addDomains(DOM_ID, DOM_LEVEL, DOM_KIND,
    ...
    public static final TableDefinition TBL_BOOK_LIST_NODE_SETTINGS = new TableDefinition(TBL_BOOK_LIST_NAME + "_node_settings")
            .addDomains(DOM_ID, DOM_KIND, DOM_ROOT_KEY)
