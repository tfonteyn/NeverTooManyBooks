...
public final class RowKinds {
    ...
    static {
        ...
        allKinds.put(ROW_KIND_DATE_PUBLISHED_YEAR, new RowKind(R.string.lbl_publication_year, "yrp"));
        allKinds.put(ROW_KIND_DATE_PUBLISHED_MONTH, new RowKind(R.string.lbl_publication_month, "mnp"));
        allKinds.put(ROW_KIND_TITLE_LETTER, new RowKind(R.string.style_builtin_title_first_letter, "t"));
        allKinds.put(ROW_KIND_DATE_ADDED_YEAR, new RowKind(R.string.lbl_added_year, "yra"));
        allKinds.put(ROW_KIND_DATE_ADDED_MONTH, new RowKind(R.string.lbl_added_month, "mna"));
        allKinds.put(ROW_KIND_DATE_ADDED_DAY, new RowKind(R.string.lbl_added_day, "dya"));
        allKinds.put(ROW_KIND_FORMAT, new RowKind(R.string.lbl_format, "fmt"));
        allKinds.put(ROW_KIND_DATE_READ_YEAR, new RowKind(R.string.lbl_read_year, "yrr"));
        allKinds.put(ROW_KIND_DATE_READ_MONTH, new RowKind(R.string.lbl_read_month, "mnr"));
        allKinds.put(ROW_KIND_DATE_READ_DAY, new RowKind(R.string.lbl_read_day, "dyr"));
        ...
        allKinds.put(ROW_KIND_DATE_LAST_UPDATE_YEAR, new RowKind(R.string.lbl_update_year, "yru"));
        allKinds.put(ROW_KIND_DATE_LAST_UPDATE_MONTH, new RowKind(R.string.lbl_update_month, "mnu"));
        allKinds.put(ROW_KIND_DATE_LAST_UPDATE_DAY, new RowKind(R.string.lbl_update_day, "dyu"));
