...
/**
 * Fragment wrapper for the PartialDatePickerDialog dialog
 *
 * @author pjw
 */
public class PartialDatePickerDialogFragment extends DialogFragment {
    ...
    private final PartialDatePickerDialog.OnDateSetListener mDialogListener = new PartialDatePickerDialog.OnDateSetListener() {
        public void onDateSet(@NonNull final PartialDatePickerDialog dialog, final Integer year, final Integer month, final Integer day) {
            ((OnPartialDatePickerResultListener) requireActivity()).onPartialDatePickerSet(mDialogId, PartialDatePickerDialogFragment.this, year, month, day);
        }

        @Override
        public void onCancel(@NonNull final PartialDatePickerDialog dialog) {
            ((OnPartialDatePickerResultListener) requireActivity()).onPartialDatePickerCancel(mDialogId, PartialDatePickerDialogFragment.this);
        }
    };
    ...
    @NonNull
    public PartialDatePickerDialogFragment setDialogId(final int id) {
        mDialogId = id;
        return this;
    }
     ...
     */
    @NonNull
    public PartialDatePickerDialogFragment setTitle(final int title) {
        mTitleId = title;
     ...
     */
    @NonNull
    private PartialDatePickerDialogFragment setDate(@Nullable final Integer year, @Nullable final Integer month, @Nullable final Integer day) {
        mYear = year;
        mMonth = month;
        mDay = day;
        PartialDatePickerDialog d = (PartialDatePickerDialog) getDialog();
