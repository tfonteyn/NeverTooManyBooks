...
class MLACitationTest
    ...
    void cite() {
        ...
        final Citation citation = new MLACitation(style);
        final String s = citation.cite(context, book);

        final String s1 = "Adams, Douglas and Lloyd, John <i>The Deeper Meaning of Liff</i>. Pan Books, 1990.";
