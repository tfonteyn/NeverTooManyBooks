...
public class BookshelfBooklistGroupTest
    ...
    public void cc() {
        ...
        final BooklistGroup g1 = BooklistGroup.newInstance(BooklistGroup.BOOKSHELF, s1);

        final BooklistGroup g2 = new BookshelfBooklistGroup(s1, (BookshelfBooklistGroup) g1);
        assertEquals(g1, g2);
    }
}
