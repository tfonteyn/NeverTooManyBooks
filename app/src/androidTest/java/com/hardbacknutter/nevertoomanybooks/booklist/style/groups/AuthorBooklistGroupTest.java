...
public class AuthorBooklistGroupTest
    ...
    public void cc() {
        ...
        final BooklistGroup g1 = BooklistGroup.newInstance(BooklistGroup.AUTHOR, false, s1);

        final BooklistGroup g2 = new AuthorBooklistGroup(false, s1, (AuthorBooklistGroup) g1);
        assertEquals(g1, g2);
    }
}
