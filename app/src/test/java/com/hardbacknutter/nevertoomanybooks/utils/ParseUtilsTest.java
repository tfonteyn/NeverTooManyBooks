...
class ParseUtilsTest {
    ...
    private static final String TH_SPACE_SEP_DEC_SEP_IS_DOT = "1 234.56";
    private static final String TH_SPACE_SEP_DEC_SEP_IS_COMMA = "1 234,56";
    ...
    void parseFloat10() {
        ...
        assertNotEquals(1234.56f, ParseUtils.parseFloat(LOCALE, TH_SPACE_SEP_DEC_SEP_IS_DOT));
        ...
        assertNotEquals(1234.56f, ParseUtils.parseFloat(LOCALE, TH_SPACE_SEP_DEC_SEP_IS_COMMA));
    }
