...
public class ShowBookDetailsActivityViewModel
   ...
   private Fields initFields(@NonNull final Context context) {
      ...
      fields.add(R.id.description, new TextViewAccessor<>(htmlFormatter), DBKey.KEY_DESCRIPTION);

      fields.add(R.id.genre, new TextViewAccessor<>(), DBKey.KEY_GENRE)
            .setRelatedFields(R.id.lbl_genre);

      fields.add(R.id.language, new TextViewAccessor<>(languageFormatter), DBKey.KEY_LANGUAGE)
            .setRelatedFields(R.id.lbl_language);

      fields.add(R.id.pages, new TextViewAccessor<>(new PagesFormatter()), DBKey.KEY_PAGES);
      ...
      fields.add(R.id.price_listed, new TextViewAccessor<>(moneyFormatter), DBKey.PRICE_LISTED)
      ...
      fields.add(R.id.date_acquired, new TextViewAccessor<>(dateFormatter), DBKey.DATE_ACQUIRED)
      ...
      fields.add(R.id.notes, new TextViewAccessor<>(htmlFormatter), DBKey.KEY_PRIVATE_NOTES)
            .setRelatedFields(R.id.lbl_notes);

      fields.add(R.id.read, new BooleanIndicatorAccessor(), DBKey.BOOL_READ);
      fields.add(R.id.read_start, new TextViewAccessor<>(dateFormatter), DBKey.DATE_READ_START)
            .setRelatedFields(R.id.lbl_read_start);
      fields.add(R.id.read_end, new TextViewAccessor<>(dateFormatter), DBKey.DATE_READ_END)
            .setRelatedFields(R.id.lbl_read_end);

      fields.add(R.id.signed, new BooleanIndicatorAccessor(), DBKey.BOOL_SIGNED);

      fields.add(R.id.price_paid, new TextViewAccessor<>(moneyFormatter), DBKey.PRICE_PAID)
