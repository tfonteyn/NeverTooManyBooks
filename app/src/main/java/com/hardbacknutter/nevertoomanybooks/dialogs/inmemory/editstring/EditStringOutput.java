...
class EditStringOutput
        implements LauncherOutput {

    private static final String TAG = "EditStringOutput";
     ...
     */
    EditStringOutput(@Nullable final String original,
    ...
    @NonNull
    static EditStringOutput fromBundle(@NonNull final Bundle args) {
        ...
        return new EditStringOutput(previousValue, currentValue, extras);
    }
