...
import com.hardbacknutter.nevertoomanybooks.goodreads.taskqueue.TQEvent;
import com.hardbacknutter.nevertoomanybooks.goodreads.taskqueue.TQTask;
import com.hardbacknutter.nevertoomanybooks.goodreads.tasks.SendOneBookGrTask;

/**
 * All Event objects resulting from sending books to Goodreads.
 */
public abstract class SendBookEvent
        extends TQEvent {
