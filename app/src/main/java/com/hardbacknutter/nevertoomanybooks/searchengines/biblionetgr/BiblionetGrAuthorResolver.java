...
public final class BiblionetGrAuthorResolver {

    private BiblionetGrAuthorResolver() {
    }
    ...
    public static List<AuthorResolver> create(@NonNull final Context context,
        ...
        if (AuthorResolverHelper.isEnabled(EngineId.BiblionetGr, EngineId.Wikidata, false)) {
