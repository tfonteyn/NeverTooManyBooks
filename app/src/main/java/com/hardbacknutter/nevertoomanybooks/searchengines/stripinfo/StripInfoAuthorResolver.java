...
public final class StripInfoAuthorResolver {

    private StripInfoAuthorResolver() {
    }
    ...
    public static List<AuthorResolver> create(@NonNull final Context context,
        ...
        if (AuthorResolverHelper.isEnabled(EngineId.StripInfoBe, EngineId.Bedetheque, true)) {
            return BedethequeAuthorResolver.create(context, searchEngine);
        }
        return List.of();
    }
}
