...
public class KbNlHtmlSearchEngine
     ...
     */
    @Keep
    public KbNlHtmlSearchEngine(@NonNull final Context context,
    ...
    private void ensureCookie()
            throws SearchException {
        try {
            httpFutureFactory.head(KbNlSearchEngine.HOST_URL + "/cbs/");
    ...
    public Optional<String> searchCoverByEdition(@NonNull final Context context,
        ...
        if (altEdition instanceof AltEditionProductCode) {
            ...
            return httpCallFactory.saveImage(url, null, codeStr, cIdx, size);
        }
