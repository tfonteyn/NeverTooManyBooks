...
public class BibliotecePlPreferencesFragment
    ...
    protected SettingsManager.Builder onCreateSettings() {
        ...
        final String pk = EngineId.BibliotecePl.getPreferenceKey();

        factory.header(EngineId.BibliotecePl.getLabelResId());
        ...
        factory.bool(AuthorResolverHelper.getPreferenceKey(EngineId.BibliotecePl,
                                                           EngineId.Wikidata),
                     0, null, p -> {
