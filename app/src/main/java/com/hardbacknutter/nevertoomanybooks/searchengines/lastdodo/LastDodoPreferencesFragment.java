...
public class LastDodoPreferencesFragment
    ...
    protected SettingsManager.Builder onCreateSettings() {
        ...
        final String pk = EngineId.LastDodoNl.getPreferenceKey();

        factory.header(EngineId.LastDodoNl.getLabelResId());
        ...
        factory.bool(AuthorResolverHelper.getPreferenceKey(EngineId.LastDodoNl,
                                                           EngineId.Bedetheque),
                     0, null, p -> {
