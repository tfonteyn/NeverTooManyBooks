...
public class Ext2MultiSelectListPreferenceDialogFragment
    ...
    public Dialog onCreateDialog(@Nullable final Bundle savedInstanceState) {
        return new MaterialAlertDialogBuilder(requireContext())
                ...
                // Selecting a line will update the ViewModel
                .setMultiChoiceItems(delegate.getEntries(),
                                     delegate.getInitialSelection(),
                                     (d, item, isChecked) -> delegate.onSelect(item, isChecked))
                // Confirmation will set the value and dismiss the dialog
                .setPositiveButton(delegate.getPositiveButtonText(),
