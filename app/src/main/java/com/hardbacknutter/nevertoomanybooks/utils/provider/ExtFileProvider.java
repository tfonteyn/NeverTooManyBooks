...
public class ExtFileProvider
    ...
    public ExtFileProvider() {
        this(ResourcesCompat.ID_NULL);
    }

    protected ExtFileProvider(@XmlRes int resourceId) {
    ...
    @CallSuper
    @Override
    public void attachInfo(@NonNull Context context,
    ...
    @VisibleForTesting
    static XmlResourceParser getFileProviderPathsMetaData(Context context,
                                                          String authority,
    ...
    static class SimplePathStrategy
        ...
        public Uri getUriForFile(File file) {
            ...
            for (Map.Entry<String, File> root : mRoots.entrySet()) {
                ...
                if (belongsToRoot(path, rootPath) && (mostSpecific == null
                                                      || rootPath.length() > mostSpecific.getValue()
                                                                                         .getPath()
                                                                                         .length())) {
                    mostSpecific = root;
                }
         ...
         */
        private boolean belongsToRoot(@NonNull String filePath,
    ...
    private static File buildPath(File base,
                                  String... segments) {
        File cur = base;
    ...
    private static String[] copyOf(String[] original,
                                   int newLength) {
