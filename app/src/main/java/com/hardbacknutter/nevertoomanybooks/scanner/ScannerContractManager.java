 ...
 */
public final class ScannerContractManager {
    ...
    private static final SparseArray<Class<? extends ScannerContractFactory>>
            SCANNER_FACTORIES = new SparseArray<>();

    static {
        SCANNER_FACTORIES.put(EMBEDDED_ZXING,
                              EmbeddedZxingScannerContract.Factory.class);
        SCANNER_FACTORIES.put(GOOGLE_PLAY_SERVICES,
                              GoogleBarcodeScannerContract.Factory.class);
        SCANNER_FACTORIES.put(ZXING,
                              ZxingScannerContract.Factory.class);
        SCANNER_FACTORIES.put(ZXING_COMPATIBLE,
                              ZxingScannerContract.FactoryCompat.class);
        SCANNER_FACTORIES.put(PIC2SHOP,
                              Pic2ShopScannerContract.Factory.class);
    }

    private ScannerContractManager() {
    }
     ...
     */
    public static void installScannerContract(@NonNull final Activity activity,
                                              @NonNull final Consumer<Boolean> resultConsumer) {
        ScannerContractFactory sf = null;
        try {
    ...
    private static void installScanner(@NonNull final Activity activity,
                                       @NonNull final ScannerContractFactory sf,
                                       @NonNull final Consumer<Boolean> resultConsumer) {
    ...
    public static void setDefaultScanner(@NonNull final Context context) {
        PreferenceManager.getDefaultSharedPreferences(context)
                         ...
                         .putString(Prefs.pk_scanner_preferred,
                                    String.valueOf(ScannerContractManager.DEFAULT))
                         .apply();
    }
