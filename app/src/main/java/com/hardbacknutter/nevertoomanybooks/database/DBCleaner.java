...
public class DBCleaner {
    ...
    /** Database Access. */
    @NonNull
    private final SynchronizedDb synchronizedDb;
    @NonNull
    ...
    public DBCleaner() {
        ...
        synchronizedDb = serviceLocator.getDb();
    }
    ...
    public void datetimeFormat() {
        ...
        for (final String key : columns) {
            try (Cursor cursor = synchronizedDb.rawQuery(
            ...
            try (SynchronizedStatement stmt = synchronizedDb.compileStatement(
    ...
    private void booleanCleanup(@NonNull final String table,
        ...
        try (SynchronizedStatement stmt = synchronizedDb.compileStatement(sql)) {
            stmt.bindLong(1, 1);
    ...
    private void toLog(@NonNull final String state,
        ...
        if (BuildConfig.DEBUG /* always */) {
            try (SynchronizedCursor cursor = synchronizedDb.rawQuery(query, null)) {
