...
public class StyleDaoImpl
    ...
    public boolean update(@NonNull final ListStyle style) {
        ...
        cv.put(DBKeys.KEY_STYLE_IS_PREFERRED, style.isPreferred());
        cv.put(DBKeys.KEY_STYLE_MENU_POSITION, style.getMenuPosition());

        return 0 < mDb.update(TBL_BOOKLIST_STYLES.getName(), cv, DBKeys.KEY_PK_ID + "=?",
