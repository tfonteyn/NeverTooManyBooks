...
public final class CalibreLibraryDao
        extends BaseDao {

    /** Log tag. */
    private static final String TAG = "CalibreLibraryDao";
    ...
    private static final String SELECT_LIBRARY_BY_UUID =
            BASE_SELECT_LIB + _WHERE_ + KEY_CALIBRE_LIBRARY_UUID + "=?";

    private static final String SELECT_LIBRARY_BY_STRING_ID =
            BASE_SELECT_LIB + _WHERE_ + KEY_CALIBRE_LIBRARY_STRING_ID + "=?";

    private static final String SELECT_LIBRARY_BY_ID =
            BASE_SELECT_LIB + _WHERE_ + KEY_PK_ID + "=?";

    /** The list of all physical Calibre libraries. */
    private static final String SELECT_LIBRARIES =
            BASE_SELECT_LIB + _ORDER_BY_ + KEY_CALIBRE_LIBRARY_NAME + _COLLATION;
    ...
    private static final String SELECT_VLIB_BY_LIBRARY_ID_AND_NAME =
            BASE_SELECT_VLIB
            + _WHERE_ + KEY_FK_CALIBRE_LIBRARY + "=?"
            + _AND_ + KEY_CALIBRE_LIBRARY_NAME + "=?";
    ...
    /** Singleton. */
    private static CalibreLibraryDao sInstance;
     ...
     */
    private CalibreLibraryDao(@NonNull final Context context,
                              @NonNull final String logTag) {
        super(context, logTag);
    }

    public static CalibreLibraryDao getInstance() {
        if (sInstance == null) {
            sInstance = new CalibreLibraryDao(App.getDatabaseContext(), TAG);
        }
