...
public final class MaintenanceDao
    ...
    /** All TocEntry titles for a rebuild of the {@link DBDefinitions#KEY_TITLE_OB} column. */
    ...
    /** Singleton. */
    private static MaintenanceDao sInstance;
     ...
     */
    private MaintenanceDao(@NonNull final Context context,
    ...
    public static MaintenanceDao getInstance() {
        if (sInstance == null) {
            sInstance = new MaintenanceDao(App.getDatabaseContext(), TAG);
        }
