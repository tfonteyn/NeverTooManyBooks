...
import com.hardbacknutter.nevertomanybooks.goodreads.tasks.AuthorizationResultCheckTask;
...
public class GoodreadsAuthorizationActivity
     ...
     * <p>
     * scheme: hardbacknutter.nevertomanybooks
     * host: goodreadsauth
     *
     * <pre>
     *     {@code
     ...
     *                  android:scheme="hardbacknutter.nevertomanybooks" />
     *          </intent-filter>
     *      </activity>
     *      }
     * </pre>
    ...
    public static final String AUTHORIZATION_CALLBACK =
            "hardbacknutter.nevertomanybooks://goodreadsauth";
